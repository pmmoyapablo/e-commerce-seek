package com.seek.users.infrastructure.adapter.out.persistence.repository;
...
public interface SpringDataJpaUserRepository extends JpaRepository<TransactionEntity, Long> {
